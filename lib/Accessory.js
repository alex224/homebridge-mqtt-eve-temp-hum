...
class EVETempHumAccessory {
    constructor(log, config) {
      ...
      this.mqtt = new MQTTClient(this.config, this.log);
    ...
    addFakeGatoHistoryEntry() {
      //if (this.humidity == null && !this.config.topicHumi) {
      //  this.humidity = 11;
      //}

      //this.log.warn("addFakeGatoHistoryEntry " + this.temperature + " - " + this.humidity);
      const temperatureNotDefined = this.temperature == null || this.temperature == undefined;
      const humidityNotDefined = this.humidity == null || this.humidity == undefined;
      
      if (!this.fakeGatoEnabled || (temperatureNotDefined && humidityNotDefined)) {
        return;
      }
      //this.log.warn("addFakeGatoHistoryEntry added");
    ...
    getTemperatureService() {
      if (this.config.topic || this.config.topicTemp) {
        ...
        this.log("Ignoring TemperatureSensor");
        return undefined;
      }
    }
  
    getHumidityService() {
      if (this.config.topic || this.config.topicHumi) {
        ...
        this.log("Ignoring HumiditySensor");
        return undefined;
      }
    }
